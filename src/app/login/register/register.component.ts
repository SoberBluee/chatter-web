...
export class RegisterComponent implements OnInit {
    ...
    public get compareEmail(): boolean {
        const result =
            ...
            this.registerForm.value.confirmEmail
                ? true
                : false
        return result
    }
    ...
    public get comparePassword(): boolean {
        const result =
            this.registerForm.value.rPassword !==
    ...
    public get comparePasswordInput(): boolean {
        return (
            this.registerForm.value.rPassword.$touched &&
            this.registerForm.value.confirmPassword.$touched
        )
    }
